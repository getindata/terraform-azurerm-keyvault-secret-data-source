...
| <a name="input_key_vaults"></a> [key\_vaults](#input\_key\_vaults) | Specifies objects to retrieve from key vaults | <pre>map(object({<br>    key_vault_id = string<br>    secrets      = optional(set(string), [])<br>  }))</pre> | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_key_vaults"></a> [key\_vaults](#output\_key\_vaults) | Key vaults with retrieved objects |
